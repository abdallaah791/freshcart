...
<header className="fixed bg-gray-300 inset-x-0 top-0 z-50 capitalize">
  <nav className="flex items-center justify-between p-6 py-3 lg:px-8" aria-label="Global">
    ...
    <div className="flex lg:hidden">
      <button onClick={()=> setIsOpen(true)} type="button" className="-m-2.5 inline-flex items-center bg-gray-200 hover:bg-gray-400 justify-center rounded-md p-2.5 text-gray-700">
    ...
    {userToken &&    <div className="hidden lg:flex lg:gap-x-3">
      <NavLink to={'home'} className="text-sm/6 font-semibold text-gray-500">home</NavLink>
      <NavLink to={'categories'} className="text-sm/6 font-semibold text-gray-500">categories</NavLink>
      <NavLink to={'brands'} className="text-sm/6 font-semibold text-gray-500">brands</NavLink>
      <NavLink to={'products'} className="text-sm/6 font-semibold text-gray-500">products</NavLink>
      <NavLink to={'wishlist'} className="text-sm/6 font-semibold text-gray-500">wish list</NavLink>
    </div>}
    ...
    <div className="hidden lg:flex lg:flex-1 lg:justify-end space-x-4">
      ...
      <>
            <NavLink to={'cart'} className="text-sm/6 font-semibold text-gray-500"><i className='fas fa-shopping-cart'></i> {cart.numOfCartItems} </NavLink>


                  <span onClick={()=> logOut()} className="text-sm/6 text-gray-600">Logout </span> :

      
      </>
      :
       <>
       <NavLink to={''} className="text-sm/6 text-gray-600">register </NavLink>
